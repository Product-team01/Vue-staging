...
**Note:** The configuration fields will be displayed for the Manual setup method.

2. Choose the data format: either CSV or JSON.

 **Note:** A sample data file for the selected format can be provided upon request.

3. Enter the Kafka broker details, including the host and port.

4. Enter the necessary credentials or authentication information, such as username and password, if required.
